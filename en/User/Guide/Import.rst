...
.. note::
    ...
    (thanks to the "File" API of HTML5). In some conditions these thumbnails
    may not be displayed (many large files, unsupported rendering by the
    browser... etc.). Consider that it's not a problem of the application.
