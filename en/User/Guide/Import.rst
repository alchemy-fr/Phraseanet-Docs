...
.. topic:: The essential
    ...
    Production by a link located in Phraseanet menu bar.
...
Click on the **Use the Flash uploader** item in bottom right menu list.
...
.. note::
    ...
    In the Upload interface thumbnails are generated by the browser itself.
    In some conditions these thumbnails may not be displayed (large files,
    unsupported rendering by the browser... etc.). Consider that it's not a
    problem of the application, just a technical limitation.

From Phraseanet 4.0.8 it is possible to upload file by URL:

* Enter the URL of the resource in the form field
* Click on the button **Add this URL**
