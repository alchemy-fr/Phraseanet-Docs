...
The workspace of Production is divided in 4 parts:
...
the nature of the *preview* subview defined in the settings of the base
...
* **A generic icon** if the system does not recognize the file type or can't
  generate any subview files.
...
* On the right side, three tabs display the description, the history and
...
Click on **Close** or use the *Escape key* of keyboard to close the window.
...
clicking on its frame. The background of the thumbnail changes color.
...
.. note::
  ...
  :ref:`Display Preferences<Customize-Display-Settings>`.
...
The number of selected documents is displayed on the bottom left side of the
display area.
...
subsequently.
A default basket exists and others can be created.
...
* Click on the pop-up menu of the Basket / Story tab in the work zone
* Click on **New basket**
