...
web browsers. It allows to :doc:`view documents <Display>`.
...
:doc:`know users feedback on the media <Push>`.
...
.. seealso::
    ...
    :doc:`Refer to the section dedicated to the Thesaurus<Thesaurus>`.
