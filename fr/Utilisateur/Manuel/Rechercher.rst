...
Egalement, "tout" ou "all" permet d'afficher tous les documents de la collection 
cochée.
...
******************************
Il est possible de limiter le cadre de la recherche à une rubrique de la description. Ainsi rechercher marra* dans legende affichera les documents qui contiennent le mot marrakech dans le champs légende.
...
NB : Il n’est pas possible de chercher à la fois sur des reportages et des 
documents.

  * Choisir le type de documents : par défaut tous les types

Sélectionner le moteur de recherche à utiliser : par défaut les deux moteurs 
sont actifs.
