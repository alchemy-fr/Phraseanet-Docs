...
publications.
Ces publications sont également disponibles sous forme de flux media RSS.
...
* Choisir le fil disponible dans la liste
...
* Sélectionner une ou plusieurs enregistrements dans *Phraseanet Production*.
