...
Le Push est une soumission de documents dans
...
Il notifie, alerte par email et met à la disposition des utilisateurs des
sélections de média provenant de paniers qu'ils peuvent consulter et
télécharger.
...
.. note:: Les utilisateurs listés dans la zone des destinataires de l'envoi
          ...
          l'enregistrer en cliquant sur l'icône :
...
**Pour activer ou désactiver cette option**, cliquer sur le bouton Contribuer ou
sur l'icône
...
.. note:: Un dispositif de recherche et de filtres permet de limiter l'affichage
          des utilisateurs par leurs identifiants, noms ou prénom, activité,
          société… *etc.*
...
.. Note :: Si le nom de la liste supprimée figure toujours dans la liste des 
           listes d'envoi, cliquer sur le lien *Rafraîchir* situé à gauche de
           l'interface.
