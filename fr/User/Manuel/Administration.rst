...
Certaines de ces rubriques comportent des sous-rubriques. Cliquer sur les
boutons " + " pour les afficher et les boutons " - " pour les masquer.

Pour accéder à une rubrique ou sous-rubrique de Phraseanet Admin, cliquer sur
son icône ou son intitulé.

Afin de présenter les principale fonctionnalités du module Phraseanet Admin,
